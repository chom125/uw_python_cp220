...
import geocoder, json, pathlib, re, requests, sys, pprint
# import json
# import pathlib
# import re
# import requests
...
# parser = argparse.ArgumentParser(description='Inspection scores')
# parser.add_argument('Average Score', type=int, help='Average inspection score')
# parser.add_argument('High Score', type=int, help='High inspection score')
# parser.add_argument('Total Inspections', type=int, help='Total number of inspections')
